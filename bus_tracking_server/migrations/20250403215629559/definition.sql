...
--
-- Class DriverInfo as table driver_info
--
...
--
-- Class GPSData as table gps_data
--
...
--
-- Class Station as table station
--
...
--
-- Foreign relations for "bus" table
--
...
--
-- Foreign relations for "driver_info" table
--
...
--
-- Foreign relations for "gps_data" table
--
...
--
-- Foreign relations for "stop" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('bus_tracking', '20250403215629559', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250403215629559', "timestamp" = now();
